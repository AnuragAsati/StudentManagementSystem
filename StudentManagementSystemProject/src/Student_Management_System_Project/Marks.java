...
Marks(String rollno){
    ...
    setLocation(500,100);
     setLayout(null);
        ...
        JLabel heading = new JLabel("RJPV university");
        ...
        JLabel lblsemester = new JLabel();
         lblsemester.setBounds(60,130,500,18);
        ...
        try{
            ...
            while(rs2.next()){
                ...
                sub2.setText(sub2.getText() +  "-------" + rs2.getString("marks1"));
                sub3.setText(sub3.getText() +  "-------" + rs2.getString("marks1"));
                sub4.setText(sub4.getText() +  "-------" + rs2.getString("marks1"));
